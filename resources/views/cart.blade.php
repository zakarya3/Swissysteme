    ...
    <div class="row">
      ...
      <section class="col-lg-8">
        <div class="d-flex justify-content-between align-items-center pt-3 pb-4 pb-sm-5 mt-1">
          <h2 class="h6 text-light mb-0">Les articles</h2><a class="btn btn-outline-primary btn-sm ps-2" href="{{ url('/') }}"><i class="fas fa-arrow-left"></i>Continue shopping</a>
        </div>
        @php
        $total = 0;
      @endphp
                  ...
                  <div class="d-sm-flex justify-content-between align-items-center my-2 pb-3 border-bottom product_data">
                    ...
                    <div class="pt-2 pt-sm-0 ps-sm-3 mx-auto mx-sm-0 text-center text-sm-start" style="max-width: 9rem;">
                     @if ($item->quantity >= $item->qty)
                      ...
                      <button class="btn btn-link px-0 text-danger" type="submit"><i class='fas fa-check-circle' ></i><span class="fs-sm">Modifier</span></button>
                      </form>
                      @php
                     ...
                     @endif
                      <form action="{{ route('cart.remove') }}" method="post">
                        ...
                        <button class="btn btn-link px-0 text-danger" type="submit"><i class='fas fa-exclamation-circle'></i><span class="fs-sm">Supprimer</span></button>
                      </form>
                    </div>
                  </div>
                ...
                <a class="btn btn-outline-accent w-100 mt-4" href="{{ url('/') }}" type="button"><i class="fas fa-arrow-left"></i>Continuer Mes Achats</a>
      </section>
      <!-- Sidebar-->
        ...
        <div class="bg-white rounded-3 shadow-lg p-4">
          <div class="py-2 px-xl-2">
            ...
            <form action="{{ route('check.list') }}" method="post">
              ...
              <a class="btn btn-primary btn-shadow d-block w-100 mt-4" type="submit" href="{{ url('checkout') }}"><i class="fas fa-credit-card"></i>Commander</a>
            </form>
          </div>
        </div>
      </aside>
